          ...
          <div className="lg:w-3/5 lg:pl-8 mt-8 lg:mt-0 text-black">
            ...
            <div className="mt-4">
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <a href={`https://wa.me/send?Phone=94770110001&text=Hi,%20I%20want%20to%20order%20this%20product;%0A${'Item: ' + detailProduct.title}%0A${'Model: ' + detailProduct.description}%0A${'Price: ' + detailProduct.price}%0A${detailProduct.discountprice ? 'Discount price: ' + detailProduct.discountprice : ''}%0A%0APage URL: ${window.location.href}`} style={{ textDecoration: 'none' }}>
