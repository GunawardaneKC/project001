...
>
  ...
  <form className="col-span-1" onSubmit={handleSubmit}>
    <div className="mb-4">
              ...
              <div className="mb-4">
                <label htmlFor="categories" className="text-white">Category:</label>
                <select className='bg-gray-200 rounded-lg p-2 w-full text-slate-950' name="category" value={selectedCategory} onChange={handleChangeInput} >
                  ...
                  {subcategories.length > 0 && (
                    <div className="mb-4">
                      <label htmlFor="subcategories" className="text-white">Subcategory</label>
                      <select className="bg-gray-200 rounded-lg p-2 w-full text-slate-950" name="subcategory" value={selectedSubcategory} onChange={(e) => setSelectedSubcategory(e.target.value)}>
